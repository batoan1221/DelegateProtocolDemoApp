...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"You've Selected By didSelectRow"
                                                    message:[NSString stringWithFormat:@"%@",[self.categoryNameArray objectAtIndex:indexPath.row]]
                                                   delegate:self
...
- (void)detailButtonPressed:(UITableViewCell *)cell button:(id)sender{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"You've Selected By Delegate"
                                                    message:[NSString stringWithFormat:@"%@",[self.categoryNameArray objectAtIndex:indexPath.row]]
                                                   delegate:self
                                          cancelButtonTitle:@"OK"
                                          otherButtonTitles:nil, nil];
